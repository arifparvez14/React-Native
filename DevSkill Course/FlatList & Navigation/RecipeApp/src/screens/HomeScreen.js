...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      {/* Flat list for two items per column */}
      {/* <FlatList
        data={RECIPES}
        ...
        ListHeaderComponent={
          <View style={{marginBottom: 20}}>
              <TextInput placeholder="Search by recipe name" style={styles.textInput}></TextInput>
          </View>
        }
      /> */}
      ...
      {/* <View>
        <View style={{ marginBottom: 20 }}>
          <TextInput
            placeholder="Search by recipe name"
            style={styles.textInputHorizontal}
          ></TextInput>
        </View>
        <FlatList
          data={RECIPES}
